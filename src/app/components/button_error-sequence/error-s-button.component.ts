...
@Component({
    selector: 'error-s-button',
    templateUrl: './error-s-button.component.html',
    styleUrls: ['./error-s-button.component.css'],
    standalone: true,
    imports: [
        MatIconButton,
        MatIconModule,
...
export class ErrorSeqButtonComponent implements OnDestroy {
